...
\begin{alltt}
\hlkwd{library}\hlstd{(ggplot2,} \hlkwc{version} \hlstd{=} \hlstr{"0.8.9"}\hlstd{)}
\hlkwd{library}\hlstd{(MASS,} \hlkwc{version} \hlstd{=} \hlstr{"7.3-x"}\hlstd{)}
\hlkwd{library}\hlstd{(Matrix,} \hlkwc{version} \hlstd{=} \hlstr{">=1.0"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
